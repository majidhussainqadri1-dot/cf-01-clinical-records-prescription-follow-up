...
| CF01-A-022 | Enforce presence and semantic minimums of the public C1-A governance package in CI | QA / Security | repository validator and tests; File 00/File 02/File 08 evidence reconciled into central tracking | green CI on the current central head and every subsequent change | In Review |
